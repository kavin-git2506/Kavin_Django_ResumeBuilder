...
def signup(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('some_success_url')  # Replace 'some_success_url' with your desired redirect URL
    else:
        form = SignupForm()

    context = {
        'form': form  # Use a more descriptive name for the form context variable
    }
